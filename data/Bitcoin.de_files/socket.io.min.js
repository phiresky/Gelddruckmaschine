...
(function() {
	(function(a, b) {
		var c = a;
		(c.version =
			"0.9.16"), (c.protocol = 1), (c.transports = []), (c.j = []), (c.sockets = {}), (c.connect = function(
			a,
			d,
		) {
			...
			return !h["force new connection"] && g && (c.sockets[f] = g), (g = g || c.sockets[f]), g.of(
				e.path.length > 1 ? e.path : "",
			);
		});
		...
		(c.parseUri = function(a) {
			...
			return "document" in b
				? (
						(d = d || document.domain),
						(e =
							e || (c == "https" && document.location.protocol !== "https:" ? 443 : document.location.port))
					)
				: ((d = d || "localhost"), !e && c == "https" && (e = 443)), (c || "http") +
				"://" +
				d +
				":" +
				(e || 80);
		...
		(c.load = function(a) {
			...
			"undefined" != typeof navigator && /webkit/i.test(navigator.userAgent)), (c.ua.iDevice =
		...
		(a.EventEmitter = c), (c.prototype.on = function(a, c) {
			return this.$events || (this.$events = {}), this.$events[a]
				? b.util.isArray(this.$events[a]) ? this.$events[a].push(c) : (this.$events[a] = [this.$events[a], c])
				: (this.$events[a] = c), this;
			...
			return this.$events || (this.$events = {}), this.$events[a] || (this.$events[a] = []), b.util.isArray(
				this.$events[a],
			) || (this.$events[a] = [this.$events[a]]), this.$events[a];
		...
		(a.Transport = c), b.util.mixin(c, b.EventEmitter), (c.prototype.heartbeats = function() {
			...
			this.clearCloseTimeout(), (this.socket.connected || this.socket.connecting || this.socket.reconnecting) &&
			...
			return this.socket.setHeartbeatTimeout(), a.type == "heartbeat"
				? this.onHeartbeat()
				: (
		...
		function d(a) {
			(this.options = {
				...
				this.options,
				a,
			), (this.connected = !1), (this.open = !1), (this.connecting = !1), (this.reconnecting = !1), (this.namespaces = {}), (this.buffer = []), (this.doBuffer = !1);
		...
		(a.Socket = d), b.util.mixin(d, b.EventEmitter), (d.prototype.of = function(a) {
			...
			return (c.connecting = !0), this.handshake(function(d, e, f, g) {
				function h(a) {
					...
					c.transport.ready(c, function() {
						(c.connecting = !0), c.publish("connecting", c.transport.name), c.transport.open(), c.options[
							"connect timeout"
						] &&
				...
				(c.sessionid = d), (c.closeTimeout = f * 1e3), (c.heartbeatTimeout = e * 1e3), c.transports || (c.transports = c.origTransports = g ? b.util.intersect(g.split(","), c.options.transports) : c.options.transports), c.setHeartbeatTimeout(), h(c.transports), c.once(
					"connect",
					function() {
			...
			a &&
				...
				(this.disconnect(), this.options.reconnect && this.reconnect()), this.publish(
				"error",
				a && a.reason ? a.reason : a,
			);
			...
			function e() {
				...
				clearTimeout(a.reconnectionTimer), a.removeListener("connect_failed", f), a.removeListener(
					"connect",
					f,
				), (a.reconnecting = !1), delete a.reconnectionAttempts, delete a.reconnectionDelay, delete a.reconnectionTimer, delete a.redoTransports, (a.options[
			...
			(this.options["try multiple transports"] = !1), (this.reconnectionTimer = setTimeout(
				f,
		...
		function c(a, b) {
			(this.socket = a), (this.name = b || ""), (this.flags = {}), (this.json = new d(
				this,
				"json",
		...
		(a.SocketNamespace = c), b.util.mixin(c, b.EventEmitter), (c.prototype.$emit =
			b.EventEmitter.prototype.emit), (c.prototype.of = function() {
			...
			return "function" == typeof b &&
				((c.id = ++this.ackPackets), (c.ack = !0), (this.acks[c.id] = b)), this.packet(c);
		}), (c.prototype.emit = function(a) {
			...
			return "function" == typeof c &&
				...
				), (d.args = b), this.packet(d);
		}), (c.prototype.disconnect = function() {
			return this.name === ""
				? this.socket.disconnect()
				: (this.packet({ type: "disconnect" }), this.$emit("disconnect")), this;
		}), (c.prototype.onPacket = function(a) {
			function d() {
			...
			switch (a.type) {
				...
				case "json":
					...
					a.ack == "data" ? e.push(d) : a.ack && this.packet({ type: "ack", ackId: a.id }), this.$emit.apply(
						this,
						e,
					);
					break;
		...
		(a.websocket = d), b.util.inherit(d, b.Transport), (d.prototype.name =
			...
			var a = b.util.query(this.socket.options.query),
				d = this,
				e;
			return e || (e = c.MozWebSocket || c.WebSocket), (this.websocket = new e(
				this.prepareUrl() + a,
		...
		(a.flashsocket = c), b.util.inherit(c, b.Transport.websocket), (c.prototype.name =
			"flashsocket"), (c.prototype.open = function() {
			var a = this,
				c = arguments;
			...
			return typeof WebSocket != "undefined" && "__initialize" in WebSocket && !!swfobject
				? swfobject.getFlashPlayerVersion().major >= 10
				: !1;
		}), (c.xdomainCheck = function() {
			return !0;
		}), typeof window != "undefined" && (WEB_SOCKET_DISABLE_AUTO_INITIALIZATION = !0), b.transports.push(
			"flashsocket",
		);
		...
		var swfobject = (function() {
							...
							if (g)
								if (S(m[c].swfVersion) && !(y.wk && y.wk < 312))
									...
									(h.data = m[c].expressInstall), (h.width =
										...
										g.getAttribute("height") || "0"), g.getAttribute("class") &&
										(h.styleclass = g.getAttribute("class")), g.getAttribute("align") &&
			...
			function I(b, c, d, e) {
				...
				if (g) {
					...
					if (y.ie && y.win && g.readyState != 4) {
						var l = Q("div");
						(d += "SWFObjectNew"), l.setAttribute("id", d), g.parentNode.insertBefore(
							l,
							g,
						), (g.style.display = "none"), (function() {
			...
			function J(a) {
				if (y.ie && y.win && a.readyState != 4) {
					var b = Q("div");
					a.parentNode.insertBefore(b, a), b.parentNode.replaceChild(K(a), b), (a.style.display =
						"none"), (function() {
				...
				if (h) {
					...
					if (y.ie && y.win) {
						...
						(h.outerHTML =
							...
							">" +
							k +
							"</object>"), (n[n.length] = c.id), (g = P(c.id));
					} else {
						var m = Q(b);
			...
			function S(a) {
				var b = y.pv,
					c = a.split(".");
				return (c[0] = parseInt(c[0], 10)), (c[1] = parseInt(c[1], 10) || 0), (c[2] =
					parseInt(c[2], 10) || 0), b[0] > c[0] ||
				(b[0] == c[0] && b[1] > c[1]) ||
			...
			function T(c, d, e, f) {
				...
				if (!v || w != h) {
					var j = Q("style");
					j.setAttribute("type", "text/css"), j.setAttribute("media", h), (v = g.appendChild(j)), y.ie &&
						y.win &&
						typeof i.styleSheets != a &&
						i.styleSheets.length > 0 &&
						(v = i.styleSheets[i.styleSheets.length - 1]), (w = h);
				}
				y.ie && y.win
					? v && typeof v.addRule == b && v.addRule(c, d)
					: v && typeof i.createTextNode != a && v.appendChild(i.createTextNode(c + " {" + d + "}"));
			}
			function U(a, b) {
				if (!x) return;
			...
			var a = "undefined",
				...
				z = (function() {
					...
					((typeof i.readyState != a && i.readyState == "complete") ||
						(typeof i.readyState == a && (i.getElementsByTagName("body")[0] || i.body))) &&
						A(), t ||
						(
			...
			return {
				registerObject: function(a, b, c, d) {
					if (y.w3 && a && b) {
						var e = {};
						(e.id = a), (e.swfVersion = b), (e.expressInstall = c), (e.callbackFn = d), (m[
							m.length
						] = e), U(a, !1);
	...
	(function() {
		...
		if (!a || !a.log || !a.error) a = { log: function() {}, error: function() {} };
		...
		location.protocol == "file:" &&
			...
			var f = this;
			(f.__id = WebSocket.__nextId++), (WebSocket.__instances[f.__id] = f), (f.readyState =
				WebSocket.CONNECTING), (f.bufferedAmount = 0), (f.__events = {}), b
				? typeof b == "string" && (b = [b])
		...
		}), (WebSocket.CONNECTING = 0), (WebSocket.OPEN = 1), (WebSocket.CLOSING = 2), (WebSocket.CLOSED = 3), (WebSocket.__flash = null), (WebSocket.__instances = {}), (WebSocket.__tasks = []), (WebSocket.__nextId = 0), (WebSocket.loadFlashPolicyFile = function(
			a,
		) {
			WebSocket.__addTask(function() {
			...
			(b.id = "webSocketContainer"), (b.style.position = "absolute"), WebSocket.__isFlashLite()
				? ((b.style.left = "0px"), (b.style.top = "0px"))
				: ((b.style.left = "-100px"), (b.style.top = "-100px"));
			var c = document.createElement("div");
			(c.id = "webSocketFlash"), b.appendChild(c), document.body.appendChild(
				b,
			), swfobject.embedSWF(
			...
			return !a || !a.enabledPlugin || !a.enabledPlugin.filename
				? !1
				: a.enabledPlugin.filename.match(/flashlite/i) ? !0 : !1;
		...
		(a.XHR = d), b.util.inherit(d, b.Transport), (d.prototype.open = function() {
			...
			var b = this;
			this.socket.setBuffer(!0), (this.sendXHR = this.request("POST")), c.XDomainRequest &&
			this.sendXHR instanceof XDomainRequest
				? (this.sendXHR.onload = this.sendXHR.onerror = f)
				: (this.sendXHR.onreadystatechange = d), this.sendXHR.send(a);
		}), (d.prototype.close = function() {
		...
		(a.htmlfile = c), b.util.inherit(c, b.Transport.XHR), (c.prototype.name =
			"htmlfile"), (c.prototype.get = function() {
			...
			(a.className = "socketio"), this.doc.body.appendChild(a), (this.iframe = this.doc.createElement(
				"iframe",
			...
			if (this.iframe) {
				...
				(this.doc = null), this.iframe.parentNode.removeChild(
					this.iframe,
		...
		function e() {}
		(a["xhr-polling"] = d), b.util.inherit(d, b.Transport.XHR), b.util.merge(
			d,
			b.Transport.XHR,
			...
			var a = this;
			(this.xhr = this.request()), c.XDomainRequest && this.xhr instanceof XDomainRequest
				? ((this.xhr.onload = d), (this.xhr.onerror = f))
				: (this.xhr.onreadystatechange = b), this.xhr.send(null);
		}), (d.prototype.onClose = function() {
		...
		(a["jsonp-polling"] = e), b.util.inherit(e, b.Transport["xhr-polling"]), (e.prototype.name =
			"jsonp-polling"), (e.prototype.post = function(a) {
			function i() {
			...
			if (!this.form) {
				var e = document.createElement("form"),
					...
					h;
				(e.className = "socketio"), (e.style.position = "absolute"), (e.style.top = "0px"), (e.style.left =
					"0px"), (e.style.display = "none"), (e.target = g), (e.method = "POST"), e.setAttribute(
					"accept-charset",
					"utf-8",
			...
			this.script &&
				(this.script.parentNode.removeChild(this.script), (this.script = null)), (c.async = !0), (c.src =
				this.prepareUrl() + e), (c.onerror = function() {
				a.onClose();
			});
			var f = document.getElementsByTagName("script")[0];
			f.parentNode.insertBefore(c, f), (this.script = c), d &&
				setTimeout(function() {
