    ...
    */
       ...
       */
          ...
          */
             ...
             * Gefundene Angebote
             */
               orders: Root["Orders"]["showOrderbook"]["Response"]["Orders"][];
            };
          ...
          */
             ...
             */
               trading_partner_information: Root["Orders"]["showOrderbook"]["Response"]["Trading_Partner_Information"][];
               /**
             * order_requirements
             *
             * Voraussetzungen zum Bedienen des Angebots (s. Tabelle Order Requirements)
             */
               order_requirements: Root["Orders"]["showOrderbook"]["Response"]["Order_Requirements"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               orders: Root["Orders"]["showMyOrderDetails"]["Response"]["Order_Details"][];
               /**
             * page
             *
             * Informationen zu den möglichen Ergebnisseiten (s.Tabelle Page-Details)
             */
               page: Root["Orders"]["showMyOrders"]["Response"]["Page_Details"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               order: Root["Orders"]["showMyOrderDetails"]["Response"]["Order_Details"][];
            };
          ...
          */
             ...
             * Voraussetzungen zum Bedienen des Angebots (s. Tabelle Order Requirements)
             */
               order_requirements: Root["Orders"]["showMyOrderDetails"]["Response"]["Order_requirements"][];
               /**
             * created_at
             *
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               trades: Root["Trades"]["showMyTradeDetails"]["Response"]["Trade_Details"][];
               /**
             * page
             *
             * Informationen zu den möglichen Ergebnisseiten (s.Tabelle Page-Details)
             */
               page: Root["Trades"]["showMyTrades"]["Response"]["Page_Details"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               trade: Root["Trades"]["showMyTradeDetails"]["Response"]["Trade_Details"][];
            };
          ...
          */
             ...
             */
               trading_partner_information: Root["Trades"]["showMyTradeDetails"]["Response"]["Trading_Partner_Information"][];
               /**
             * created_at
             *
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               data: Root["Sonstiges"]["showAccountInfo"]["Response"]["Data"][];
            };
          ...
          */
             ...
             */
               btc_balance: Root["Sonstiges"]["showAccountInfo"]["Response"]["BTC_Balance"][];
               /**
             * fidor_reservation
             *
             * Infos zur ggfs. vorhandenen Fidor-Reservierung (s.Tabelle Fidor-Reservation)
             */
               fidor_reservation: Root["Sonstiges"]["showAccountInfo"]["Response"]["Fidor_Reservation"][];
               /**
             * encrypted_information
             *
             * Verschlüsselte Infos (s.Tabelle Encrypted-Information¹)
             */
               encrypted_information: Root["Sonstiges"]["showAccountInfo"]["Response"]["Encrypted_Information_"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             * Array mit Bids / Asks
             */
               orders: Root["Sonstiges"]["showOrderbookCompact"]["Response"]["Orders"];
            };
          ...
          */
             ...
             * Auflistung der Bids
             */
               bids: Root["Sonstiges"]["showOrderbookCompact"]["Response"]["Bids"][];
               /**
             * asks
             *
             * Auflistung der Asks
             */
               asks: Root["Sonstiges"]["showOrderbookCompact"]["Response"]["Asks"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               trades: Root["Sonstiges"]["showPublicTradeHistory"]["Response"]["Trade_Informationen"];
            };
          ...
          */
             ...
             */
               0: Root["Sonstiges"]["showPublicTradeHistory"]["Response"]["Trade_Informationen"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               rates: Root["Sonstiges"]["showRates"]["Response"]["Rates"][];
            };
    ...
    */
       ...
       */
          ...
          */
             ...
             */
               account_ledger: Root["Sonstiges"]["showAccountLedger"]["Response"]["Details_zur_Position"][];
               /**
             * page
             *
             * Informationen zu den möglichen Ergebnisseiten (s.Tabelle Page-Details)
             */
               page: Root["Sonstiges"]["showAccountLedger"]["Response"]["Page_Details"][];
            };

            /**
          * Details zur Position
          */
            Details_zur_Position: {
               /**
             * date
             *
             ...
             */
               trade: Root["Sonstiges"]["showAccountLedger"]["Response"]["Tradedetails"][];
               /**
             * cashflow
             *
             * Zu- / Abgang
          ...
          */
             ...
             */
               btc: Root["Sonstiges"]["showAccountLedger"]["Response"]["BTC_Summen"][];
               /**
             * euro
             *
             * Euro-Summen (s.Tabelle Euro-Summen)
             */
               euro: Root["Sonstiges"]["showAccountLedger"]["Response"]["Euro_Summen"][];
            };
